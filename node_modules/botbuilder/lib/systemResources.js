...
exports.locales['en'] = {
    "default_text": "Извините, я вас не понимаю",
    "default_number": "Введите, пожалуйста, число",
    "default_confirm": "I didn't understand. Please answer 'yes' or 'no'.",
    "default_choice": "Я вас не понимаю. Выберите пункт из списка",
    ...
    "default_error": "Произошла ошибка в боте. Пожалуйста, отправьте мне '/start'",
    "list_or": " or ",
    "list_or_more": ", or ",
    "confirm_yes": "yes",
    "confirm_no": "no",
